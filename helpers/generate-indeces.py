...
with open(os.path.dirname(__file__) + '/../challenges.json', 'r') as file_challenges, open(
                os.path.dirname(__file__) + '/../README.md', 'w') as fout:
        ...
        for chapter in track['chapters']:
            ...
            for i, challenge in enumerate(chapter['challenges']):
                ...
                challenge['table-row'] = [str(i + 1),
                                          '[%s](https://www.hackerrank.com/challenges/%s)' % (
    ...
    # write to README.md
    fout.write('HackerRank Solutions \n\n')
    fout.write('This is a collection of my [HackerRank](https://www.hackerrank.com/) \n\n'
